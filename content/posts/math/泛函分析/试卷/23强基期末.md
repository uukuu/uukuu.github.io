...
{{< admonition note "答案" false >}}
1. 等价于证明 $\forall \lambda\in\C\setminus \R$, $\lambda\in \rho(A)$.
		
    设 $\lambda=a+b\ti$, $b\neq 0$.
    
    有 $$\norm{(\lambda I-A)x}^2=((\lambda I-A)x,(\lambda I-A)x)=\norm{(aI-A)x}^2+\norm{bx}^2+(b\ti x,(aI-A)x)+((aI-A)x,b\ti x)$$ 其中 $(b\ti x,(aI-A)x)+((aI-A)x,b\ti x)=2\text{Re}((aI-A)x,b\ti x)=-2b\text{Re}\ti((aI-A)x,x)$, 由 $A$ 自伴, 故 $(Ax,x)\in \R$, 从而 $((aI-A)x,x)=a(x,x)-(Ax,x)\in \R$.
    
    所以 $\text{Re}\ti ((aI-A)x,x)=0$. 即 $\norm{(\lambda I-A)x}^2=\norm{(aI-A)x}^2+b^2\norm{x}^2$.
    ...
    则有 $\norm{y_n-y_m}^2=\norm{(\lambda I-A)(x_n-x_m)}^2\geqslant b^2\norm{x_n-x_m}^2$.
